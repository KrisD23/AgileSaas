  ...
  return (
    <div className="py-12 bg-base flex justify-center items-center h-auto">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-left mb-4">Last updated: April 18, 2024</p>
        <p>
        ...
        {/* <h4 className="text-lg font-bold text-gray-300 mb-2"></h4> */}
        ...
        <div className="m-6">
          ...
          <h3 className="text-xl font-bold text-gray-300 mb-2">Definitions</h3>
          ...
          <ul className="list-disc pl-6 mt-2">
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Agilesaas, India.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Agilesaas, accessible from{" "}
                <a
                  href="https://agilesaas.netlify.app/"
        ...
        <div className="m-6">
          ...
          <div className="mb-6">
            <h4 className="text-lg font-bold text-gray-300 mb-2">Usage Data</h4>
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-gray-300 mb-2">Contact Us</h2>
          <p>
