  ...
  return (
    <div className="py-12 bg-base flex justify-center items-center h-auto">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-4xl font-bold text-gray-300 my-16 text-center">
          Terms and Conditions
        </h2>

        <p className="mb-4">
          Welcome to Agilesaas! These terms and conditions outline the rules and
          regulations for the use of Agilesaas&apos;s Website, located at{" "}
        ...
        <p className="mb-4">
          ...
          conditions. Do not continue to use Agilesaas if you do not agree to
        ...
        {/* Each section can be styled similarly */}
        <div className="mb-6">
          <h3 className="text-xl font-bold text-gray-300 mb-2">Cookies</h3>
          <p className="mb-4">
            We employ the use of cookies. By accessing Agilesaas, you agree to
            use cookies in agreement with the Agilesaas&apos;s Privacy Policy.
          </p>
          <p>
        ...
        <div className="mb-6">
          <h3 className="text-xl font-bold text-gray-300 mb-2">License</h3>
          <p>
            Unless otherwise stated, Agilesaas and/or its licensors own the
            intellectual property rights for all material on Agilesaas. All
            intellectual property rights are reserved. You may access this from
            Agilesaas for your own personal use subjected to restrictions set in
            these terms and conditions.
          </p>
          <ul className="list-disc pl-6 mt-2">
            <li>Republish material from Agilesaas</li>
            <li>Sell, rent or sub-license material from Agilesaas</li>
            <li>Reproduce, duplicate or copy material from Agilesaas</li>
            <li>Redistribute content from Agilesaas</li>
          </ul>
        </div>
        ...
        <div className="mb-6">
          ...
          <p className="mb-4">
            Agilesaas does not filter, edit, publish or review Comments prior to
            their presence on the website. Comments do not reflect the views and
            opinions of Agilesaas,its agents and/or affiliates. Comments reflect
            the views and opinions of the person who post their views and
            opinions. To the extent permitted by applicable laws, Agilesaas
          ...
          <p className="mb-4">
            Agilesaas reserves the right to monitor all Comments and to remove
          ...
          <ul className="mb-4 list-disc pl-6 mt-2">
            <li>
          ...
          <p className="mb-4">
            You hereby grant Agilesaas a non-exclusive license to use,
        ...
        <div className="mb-6">
          ...
          <p className="mb-4">
            ...
            visibility of the hyperlink compensates the absence of Agilesaas;
          ...
          <p className="mb-4">
            ...
            sending an e-mail to Agilesaas. Please include your name, your
          ...
          <p className="mb-4">
            No use of Agilesaas&apos;s logo or other artwork will be allowed for
            linking absent a trademark license agreement.
          </p>
        </div>

        <div className="mb-6">
          <h3 className="text-xl font-bold text-gray-300 mb-4">iFrames</h3>
          <p className="mb-4">
        ...
        <div className="mb-6">
          <h3 className="text-xl font-bold text-gray-300 mb-2">Disclaimer</h3>
          <p className="mb-4">
            To the maximum extent permitted by applicable law, we exclude all
            representations, warranties and conditions relating to our website
            and the use of this website. Nothing in this disclaimer will:
          </p>
          {/* Add the list of exclusions here */}
